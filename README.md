...
Hi this is my edit!!!
-----------------------------------------------
And this is the second edit. Can you see it??
-----------------------------------------------
...
Saving the file simply writes the new text to your hard disk. We need to tell git that we want to preserve these changes for the project (making a "commit"), then send them
